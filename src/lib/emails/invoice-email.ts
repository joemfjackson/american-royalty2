        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td style="text-align:center;padding:0 0 32px;">
              <img src="${data.invoiceUrl.split('/invoice/')[0]}/images/logo.png" alt="American Royalty" width="180" height="180" style="display:block;margin:0 auto;width:180px;height:auto;" />
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 0 24px;">
              ...
              <p style="margin:12px 0 0;font-size:15px;color:#cccccc;line-height:1.5;">
                Thank you for choosing American Royalty! Here is the invoice for your upcoming event.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 0 32px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#111111;border:1px solid #1E1E1E;border-radius:12px;">
                ...
                <tr>
                  <td style="padding:20px;">
                    <p style="margin:0 0 16px;font-size:11px;font-weight:600;color:#999;letter-spacing:2px;text-transform:uppercase;">Payment Summary</p>
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding:8px 0;font-size:14px;color:#ccc;">Total Amount</td>
                        <td style="padding:8px 0;font-size:14px;color:#fff;text-align:right;font-weight:500;">${data.totalAmount}</td>
                      </tr>
                      <tr>
                        <td style="padding:8px 0;font-size:14px;color:#ccc;">Deposit Required (${data.depositPercent}%)</td>
                        <td style="padding:8px 0;font-size:14px;color:#D6C08A;text-align:right;font-weight:700;">${data.depositAmount}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding:12px 0 0;font-size:16px;color:#fff;font-weight:600;">Amount Due Now</td>
                        <td style="padding:12px 0 0;font-size:20px;color:#D6C08A;text-align:right;font-weight:700;">${data.depositAmount}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
          ...
          <tr>
            <td style="text-align:center;padding:0 0 32px;">
              <a href="${data.invoiceUrl}" style="display:inline-block;background-color:#D6C08A;color:#000000;font-size:16px;font-weight:700;text-decoration:none;padding:16px 48px;border-radius:8px;letter-spacing:0.5px;">
                VIEW INVOICE &amp; PAY
              </a>
            </td>
          </tr>
          ...
          <tr>
            <td style="text-align:center;padding:0 0 32px;">
              <p style="margin:0;font-size:13px;color:#999;line-height:1.5;">
                You can also pay via Zelle, Venmo, or cash.<br>
