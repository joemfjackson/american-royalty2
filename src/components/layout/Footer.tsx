  ...
  return (
    <footer className="border-t border-dark-border bg-[#0A0A0A]">
            ...
            <div className="mt-5 flex gap-3">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="flex h-11 w-11 items-center justify-center rounded-full border border-dark-border text-white/80 transition-all duration-200 hover:border-royal/40 hover:text-gold hover:bg-royal/10 hover:shadow-[0_0_15px_rgba(111,45,189,0.2)]"
                >
      ...
      <div className="border-t border-dark-border pb-16 sm:pb-0">
        ...
        <p className="pb-4 text-center text-[11px] text-white/80">
          Website designed by{' '}
          <a
            href="https://www.stage1labs.com"
            target="_blank"
            rel="noopener noreferrer"
            className="text-white/80 underline transition-colors hover:text-gold"
          >
            Stage1Labs
          </a>
        </p>
